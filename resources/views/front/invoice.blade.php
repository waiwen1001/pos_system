...
<table style="width: 100%; border-spacing: 0px; border-collapse: collapse;">
  <thead>
        ...
        <div>
          ...
          <div style="width: 100%; display: inline-block; border: 1px solid #ccc;">
            <div style="width: 300px; float: right; display: flex; text-align: left;">
              <div style="flex: 1; background: #ccc; padding: 5px; display: flex; flex-direction: column; border: 1px solid #333; border-left-color: #ccc;">
                <span style="font-size: 14px;">Invoice No</span>
                <span style="font-weight: normal; font-size: 14px;">Date</span>
                <span style="font-weight: normal; font-size: 14px;">Reference No</span>
              </div>

              <div style="flex: 1; background: #fff; padding: 5px; display: flex; flex-direction: column; border: 1px solid #333; border-top-color: #ccc;">
    ...
    <tr style="text-align: left;">
      ...
      <th style="background: #ccc; border: 1px solid #aaa; border-top: 2px solid #333; border-bottom: 1px solid #333;">
        <span style="font-size: 16px; padding-left: 5px;">CODE</span>
      </th>
      <th style="background: #ccc; border: 1px solid #aaa; border-top: 2px solid #333; border-bottom: 1px solid #333;">
        <span style="font-size: 16px; padding-left: 5px;">DESCRIPTION</span>
      </th>
      <th style="background: #ccc; border: 1px solid #aaa; border-top: 2px solid #333; border-bottom: 1px solid #333;">
        <span style="font-size: 16px; padding-left: 5px;">QUANTITY</span>
      </th>
      <th style="background: #ccc; border: 1px solid #aaa; border-top: 2px solid #333; border-bottom: 1px solid #333;">
  ...
  <tbody>
    @foreach($transaction_detail_list as $key => $detail)
      <tr>
        <td style="border-right: 1px solid #aaa; border-left: 1px solid #aaa; padding: 0 5px; text-align: right;">{{ $key + 1 }}</td>
    ...
    <tr>
      <td colspan="5" rowspan="5" style="padding: 0 5px; border: 1px solid #aaa; border-right-width: 0px; border-bottom-color: #333; border-bottom-width: 2px;">
        <div>E. & O.E.</div>
    ...
    <tr>
      <td colspan="2" style="padding: 0 5px; border-right: 1px solid #aaa; border-bottom-width: 0px;">Global Discount</td>
      <td style="padding: 0 5px; text-align: right; border-right: 2px solid #333;">0.00</td>
    </tr>
    ...
    <tr>
      <td colspan="8">
        <div style="float: right;">for HOME U (M) SDN.BHD.</div>
      </td>
    </tr>
  </tbody>
  <tfoot>
